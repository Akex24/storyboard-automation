...
class NewEpisodeView(QWidget):
    ...
    def _on_run(self):
        ...
        prompt = (
            ...
            "      • исторический → epoch-specific (Victorian, Soviet, 90s)\n"
            ...
            "  • Описание НИКУДА не записывается (ни в episodes.json, ни в\n"
            "    промпты Сценариста/Nano Banana) — оно только для юзера в чате.\n"
