...
# планом, большой запас перекрывает лицо лишним — 0.9 = сетка чуть меньше
# бокса лица. Менять ОДНОЙ цифрой здесь (на сторибордовую фичу не влияет).
ACTOR_FACE_GRID_SCALE = 0.9
