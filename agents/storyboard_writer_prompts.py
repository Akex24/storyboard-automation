...
def build_user_prompt(block: dict,
    ...
    if _mode == 'c':
        ...
        parts.append(
            "Ракурс бери из scene_action (авторский, если автор его указал) "
            "— правило приоритета авторской камеры остаётся в силе. Строка "
            "«CAMERA:» — это просто формат записи того же ракурса, не повод "
            "его менять или выдумывать новый.")
