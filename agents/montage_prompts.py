...
_rules = _mode_loader.import_rules_module()
COMMON_RULES = _rules.COMMON_RULES
STRUCTURAL_RULES = _rules.STRUCTURAL_RULES
_FALLBACK_SCRIPTWRITER_SYSTEM = _rules._FALLBACK_SCRIPTWRITER_SYSTEM
_FALLBACK_VALIDATOR_SYSTEM = _rules._FALLBACK_VALIDATOR_SYSTEM
_FALLBACK_EDITOR_SYSTEM = _rules._FALLBACK_EDITOR_SYSTEM
_FALLBACK_CONTEXT_REVIEWER_SYSTEM = _rules._FALLBACK_CONTEXT_REVIEWER_SYSTEM
_SCRIPTWRITER_ROLE = _rules._SCRIPTWRITER_ROLE
_VALIDATOR_ROLE = _rules._VALIDATOR_ROLE
_EDITOR_ROLE = _rules._EDITOR_ROLE
_REVIEWER_ROLE = _rules._REVIEWER_ROLE
_SCRIPTWRITER_JSON_TAIL = _rules._SCRIPTWRITER_JSON_TAIL
_VALIDATOR_JSON_TAIL = _rules._VALIDATOR_JSON_TAIL
_EDITOR_JSON_TAIL = _rules._EDITOR_JSON_TAIL
_REVIEWER_JSON_TAIL = _rules._REVIEWER_JSON_TAIL
_GEOMETRY_EDITOR_ROLE = _rules._GEOMETRY_EDITOR_ROLE
_GEOMETRY_EDITOR_JSON_TAIL = _rules._GEOMETRY_EDITOR_JSON_TAIL
