...
class ShimmerCell(QFrame):
    ...
    def _open_viewer(self):
        """Открыть МОДАЛЬНЫЙ (ApplicationModal) попап просмотра этой плитки. Ссылку держим
        на странице (self._page._open_viewer), чтобы окно не съел GC. Для видео — сперва
        гасим hover-превью карточки (попап играет с 0 сам), чтобы не играло в двух местах."""
