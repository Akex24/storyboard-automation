...
class GenerateThread(QThread):
    ...
    def _build_realistic_prompt(self, source_prompt: str,
        ...
        return (
            ...
            "background layout. Only the RENDER STYLE changes — everything "
            "turns into real photography.\n\n"
            "CONVERT EVERY SINGLE ELEMENT to photorealism — leave NOTHING "
            "drawn. This includes, without exception: every character, every "
            "face, every hand and finger, every arm, all clothing, sleeves "
            "and fabric folds, every held or background object (e.g. "
            "bouquets, envelopes, papers, furniture), every surface, wall, "
            "floor and the entire background. If even one region is still "
            "sketched, the result is WRONG.\n"
            ...
            "grading. Match every character's face to their reference image "
            "by the name in the legend above.\n"
